...
public class RemoveUnused extends SimpleStoryGraphTool {
	...
	public String getDescription() {
		return "Removes characters who never consent and never have beliefs. Removes fluents whose values never change. Removes values, actions, states, and plans that are never used.";
	}
